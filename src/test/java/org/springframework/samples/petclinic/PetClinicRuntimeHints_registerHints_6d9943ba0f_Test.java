...
public class PetClinicRuntimeHints_registerHints_6d9943ba0f_Test {
    ...
    @InjectMocks
    private PetClinicRuntimeHints_registerHints_6d9943ba0f petClinicRuntimeHints_registerHints_6d9943ba0f;

    @BeforeEach
    public void setup() {
        petClinicRuntimeHints_registerHints_6d9943ba0f = new PetClinicRuntimeHints_registerHints_6d9943ba0f();
    }

    @Test
    public void testRegisterHints() {
        petClinicRuntimeHints_registerHints_6d9943ba0f.registerHints(runtimeHints, this.getClass().getClassLoader());
